...
export default function PropertyExplorer({atlas,hidden,onClose,onLocate,onViewState,onMapPoint,requestedRegion}:Props){
  ...
  return <aside className={`property-panel sheet-${sheet} ${complex?'showing-complex':region?'showing-region':'showing-country'}`} data-trade={trade} hidden={hidden} aria-label="지역·아파트 분석">
